...
import static io.dongtai.iast.core.utils.matcher.structure.PrimitiveClassStructure.mappingPrimitiveByJavaClassName;
...
public class ClassStructureImplByAsm extends FamilyClassStructure {
    ...
    private Access fixAccess() {
        ...
        this.classReader.accept(new ClassVisitor(AsmUtils.api) {
            @Override
    ...
    @Override
    public String getJavaClassName() {
        return SandboxStringUtils.toJavaClassName(classReader.getClassName());
    }
    ...
    private final LazyGet<ClassStructure> superClassStructureLazyGet
        ...
        protected ClassStructure initialValue() {
            ...
            return newInstance(SandboxStringUtils.toJavaClassName(superInternalClassName));
        }
    };
    ...
    private final LazyGet<List<ClassStructure>> annotationTypeClassStructuresLazyGet
        ...
        protected List<ClassStructure> initialValue() {
            ...
            accept(new ClassVisitor(AsmUtils.api) {
        ...
        protected List<BehaviorStructure> initialValue() {
            ...
            accept(new ClassVisitor(AsmUtils.api) {
                ...
                public MethodVisitor visitMethod(final int access,
                    ...
                    return new MethodVisitor(AsmUtils.api, super.visitMethod(access, name, desc, signature, exceptions)) {
